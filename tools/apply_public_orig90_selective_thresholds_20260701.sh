...
CAND_CSV=runs/topk_public_20260701/orig90_adapt10_tau003_b5_a075_m093/predictions.csv
BASE_TOPK=runs/topk_public_20260701/h8192_taxon_tau002_b5/topk.csv
CAND_TOPK=runs/topk_public_20260701/orig90_adapt10_tau003_b5_a075_m093/topk.csv

run_one() {
  local name=$1
  local base_margin=$2
  local cand_margin=$3
  local unseen_dir="runs/public_unseen_selective_20260701/h8192_orig90_${name}"
  local sub_dir="runs/submission_20260701_bestseen_unseen_h8192_orig90_${name}"
...
run_one bm2_cm0 2.0 0.0
run_one bm0p5_cm0p05 0.5 0.05
run_one bm2_cm0p1 2.0 0.1
